...
public class DefaultKits {
    ...
    public static BasicKit pvpKit() {
        ...
        Ability soup = Main.getAbilityManager().getAbility("SOUPREGEN");
        if (soup != null) {
            abilities.add(soup);
        }
    ...
    public static BasicKit thorKit() {
        ...
        Ability axeStrike = Main.getAbilityManager().getAbility("AXESTRIKE");
        if (axeStrike != null) {
    ...
    public static BasicKit switcherKit() {
        ...
        Ability snowballA = Main.getAbilityManager().getAbility("SNOWBALLSWITCHER");
        if (snowballA != null) {
